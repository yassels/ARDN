...
# Indirect Attention Re-distribution
class Indirect_MHAtt(nn.Module):
    def __init__(self, __C):
        super(Indirect_MHAtt, self).__init__()
        self.__C = __C
    ...
    def att(self, value, key, query, mask):
        ...
        scores = torch.exp(scores - torch.max(scores, dim=-1, keepdim=True).values)
...
class TRAR(nn.Module):
    def __init__(self, __C):
        ...
        self.mhatt1 = Indirect_MHAtt(__C)
